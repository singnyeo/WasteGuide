...
public class FreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(FreeActivity.this, adapterView.getItemAtPosition(i) + " 클릭", Toast.LENGTH_SHORT).show();
    ...
    protected void onResume() {
        super.onResume();
        FreeActivity.GetBoard getBoard = new FreeActivity.GetBoard();
        getBoard.execute();
    }
    ...
    class GetBoard extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(FreeActivity.this, android.R.layout.simple_list_item_1, titleList);
